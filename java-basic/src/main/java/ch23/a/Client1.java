...
public class Client1 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    Socket socket = new Socket(
        "localhost", // IP 주소(ex : 234.3.4.56) 또는 도메인명(ex : ww.daum.net)
              // 특수 IP : 127.0.0.1 - 로컬 컴퓨터를 가르킨다.
              // 특수 도메인명 : localhost - 127.0.0.1을 가르킨다.
              //
    ...
    //  => 물론 해제하지 않아도 서버측에서 일정 시간이 지나면 자동으로 연결을 해제한다.
