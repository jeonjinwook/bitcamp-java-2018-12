...
public class Test01_1 {
  ...
  public static void main(String[] args) {
    ...
    try (FileWriter out = new FileWriter("data.txt")){
      ...
      out.write('간'); // => 0xEAB082 3바이트 출력
      
      // character stream 클래스 FileWriter는 문자 데이터를 출력할 떄
      // 문자 데이터를 다룰 때 사용하는 UTF-16 코드를
      ...
      // JVM을 실행할 떄 file.encoding 프로퍼티의 character set 이름을 지정하라.
      // 예) java -Dfile.encoding=UTF-8 클래스명
      // 단, character set을 지정할 떄는 해당 OS에서 사용가능한 문자표이어야 한다.
      // MS windows에서는 MS-949 문자표를 사용할 수 있지만,
      // 리눅스나 macOSdptjsms MS-949 문자표를 사용할 수 없다.
      // 왜? 국제 표준이 아니기 때문이다.
      // 결론!
      // => 무슨 OS를 사용하든지 출력할 떄는 가능한 국제 표준인 UTF-8을 사용하라.
      //
