...
<tr>
  <th>사진</th>
<td>
  <img src='../upload/member/<%=member.getPhoto() %>' style='height:80px'><input type='file' name='photo'></td>
...
<tr>
  ...
  <td><%=member.getRegisteredDate() %></td>
    ...
    <p>
      <a href='list'>목록</a><a href='../'>전체 목록</a> <a href='delete?no=<%=member.getNo()%>'>삭제</a>
