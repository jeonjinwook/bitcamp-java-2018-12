...
public class Controller05_2 {
  ...
  public Controller05_2() {
    list.add(new Board(1, "제목입니다1", "내용", "홍길동1", 10, Date.valueOf("2019-5-1")));
    ...
    list.add(new Board(6, "제목입니다6", "내용", "홍길동6", 15, Date.valueOf("2019-5-6")));
    list.add(new Board(7, "제목입니다7", "내용", "홍길동7", 16, Date.valueOf("2019-5-7")));
    list.add(new Board(8, "제목입니다8", "내용", "홍길동8", 17, Date.valueOf("2019-5-8")));
    list.add(new Board(9, "제목입니다9", "내용", "홍길동9", 18, Date.valueOf("2019-5-9")));
    list.add(new Board(10, "제목입니다10", "내용", "홍길동10", 19, Date.valueOf("2019-5-10")));
    list.add(new Board(11, "제목입니다11", "내용", "홍길동11", 1, Date.valueOf("2019-5-11")));
    list.add(new Board(12, "제목입니다12", "내용", "홍길동12", 2, Date.valueOf("2019-5-12")));
    list.add(new Board(13, "제목입니다13", "내용", "홍길동13", 3, Date.valueOf("2019-5-13")));
  }
  ...
  public Object handler4() {
    ...
    return content; // primitive 타입의 값도 그대로 출력한다.
  }
}
