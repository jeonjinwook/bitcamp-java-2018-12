...
Set-Cookie: v2=bbb; Path=/java-web/ex10/a <--- 사용 범위가 /java-web/ex10/a 로 지정되었다.
Set-Cookie: v3=ccc; Path=/java-web
Content-Type: text/plain;charset=UTF-8
Content-Length: 36
Date: Wed, 03 Apr 2019 02:05:44 GMT
 */
    // 사용 범위를 지정하지 않은쿠키
    ...
    // 어~ 왜 쿠키의 경로를 적을 때 웹 애플리케이션 경로(컨텍스트 루트)까지 적나요?
    //  => 쿠키 경로는 웹 서블릿 컨테이너가 사용하는 경로가 아니다.
    //  => 웹 브라우저가 사용하는 경로다.
