...
public class Controller04_3 {
  ...
  //    
  // 테스트:
  //    http://localhost:8080/java-spring-webmvc/app1/c04_3/h1?model=sonata&maker=hyundai&capacity=5&auto=true&engine.model=ok&engine.cc=1980&engine.valve=16
  @GetMapping("h1") 
  @ResponseBody 
  public void handler1(
      ...
      boolean auto, // 프론트가 컨트롤러가 String 값을 boolean으로 변환해 준다.
      // 단 변환할 수 없을 경우 예외가 발생한다.
      // "true", "false"는 대소문자 구분없이 true, false로 변환해 준다.
      // 1 ==> true, 0 ==> false로 변환해 준다.
